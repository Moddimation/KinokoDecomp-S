if (DEFINED ENV{PROJECT_CLANG})
    set(PROJECT_CLANG "$ENV{PROJECT_CLANG}")
else()
    set(PROJECT_CLANG "${CMAKE_CURRENT_LIST_DIR}/clang-8.0.0")
endif()
...
set(CMAKE_C_COMPILER "${PROJECT_CLANG}/bin/clang")
set(CMAKE_C_COMPILER_TARGET ${NX64_TRIPLE})
set(CMAKE_CXX_COMPILER "${PROJECT_CLANG}/bin/clang++")
...
add_link_options(-fuse-ld=${PROJECT_CLANG}/bin/ld.lld)
